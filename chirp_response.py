...
if __name__ == '__main__':
    wd = r'Z:\data\optical lever project\NORCADA_NX53515C\78-chirp_test'
    ...
    chirp_file_name = 'f={fstart:.0f}_{{fend:.0f}}'.format(fstart = fstart, fend = fend)
    FG.chirp_sine_file(wd, chirp_file_name, fstart, fend, AWGfs, AWGN, dc+amp, dc-amp)
